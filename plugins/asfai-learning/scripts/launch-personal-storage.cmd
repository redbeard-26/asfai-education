...
if "%~1"=="" (
  echo ASFAI personal storage could not start: missing server path. 1>&2
  exit /b 64
)
...
echo ASFAI personal storage could not find the runtime supplied by Codex. Update or reinstall Codex. 1>&2
exit /b 127
