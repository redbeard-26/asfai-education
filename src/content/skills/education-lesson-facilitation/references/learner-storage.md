...
6. Open a new `readonly` transaction, read `current`, and call `asfai_storage` action `verify` with the expected returned profile and actual read-back.
